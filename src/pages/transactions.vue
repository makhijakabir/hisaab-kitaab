    ...
    <div class="row q-col-gutter-sm q-ma-xs q-mr-sm">
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <q-card flat bordered class>
          <q-card-section>
            <div class="text-h6">Add a Deposit</div>
          </q-card-section>
          ...
          <q-card-section>
            <q-form>
              <q-list>
                <q-item>
                  <q-item-section>
                    <q-item-label class="q-pb-xs">Account Name</q-item-label>
                    <q-select
                      dense
                      label="Account"
                      outlined
                ...
                <q-item>
                  <q-item-section>
                    <q-item-label class="q-pb-xs">Purpose of the Deposit</q-item-label>
                    <q-input
                      dense
                      outlined
...
export default {
  data() {
    return {
      ...
      columns: [
        {
          name: "Purpose of the Deposit",
          align: "left",
          label: "Purpose of the Deposit",
          field: "description",
          sortable: true
        },
        {
